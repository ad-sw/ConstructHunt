...
function AboutUs() {
  ...
  return (
      <div className="descriptionAbout">
            <div id="textDesc">Construct Hunt surfaces the best new products, every day. It's a place for product-loving enthusiasts to share and geek out about the latest buildings, parks, city plans, neighborhoods, and hub centers in development.</div>
